...
tulis(f"Nilai: {nilai}")
tulis(f"Grade: {grade} ({keterangan})")
...
tulis(f"Angka asli: {angka_asli}")
tulis(f"Angka genap: {angka_genap}")
tulis(f"Angka kuadrat: {angka_kuadrat}")
