...
class CodingYokParser:
    ...
    def synchronize(self) -> None:
        ...
        while not self.is_at_end():
            ...
            if self.peek().type in [
                TokenType.KELAS, TokenType.FUNGSI, TokenType.JIKA,
                TokenType.UNTUK, TokenType.SELAMA, TokenType.TULIS,
    ...
    def call(self) -> Expression:
        ...
        while True:
            if self.match(TokenType.LEFT_PAREN):
                ...
                name = self.consume(TokenType.IDENTIFIER, "Diharapkan nama atribut setelah '.'")
    ...
    def class_definition(self) -> ClassDefinition:
        ...
        superclass = None
        if self.match(TokenType.LEFT_PAREN):
            superclass = self.consume(TokenType.IDENTIFIER, "Diharapkan nama superclass").value
    ...
    def if_statement(self) -> IfStatement:
        ...
        while self.match(TokenType.KALAU_TIDAK_JIKA):
            ...
            self.consume(TokenType.COLON, "Diharapkan ':' setelah kondisi kalau_tidak_jika")
    ...
    def import_statement(self) -> ImportStatement:
        ...
        if self.match(TokenType.SEBAGAI):
            alias = self.consume(TokenType.IDENTIFIER, "Diharapkan alias setelah 'sebagai'").value
    ...
    def from_import_statement(self) -> FromImportStatement:
        ...
        names.append(self.consume(TokenType.IDENTIFIER, "Diharapkan nama untuk diimpor").value)
