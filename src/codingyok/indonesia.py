...
KOTA_BESAR_INDONESIA = [
    ...
    "Pontianak", "Manado", "Mataram", "Kupang", "Jayapura"
]
...
def tanggal_indonesia(date: Optional[datetime.datetime] = None, format_panjang: bool = True) -> str:
...
def waktu_indonesia(time: Optional[datetime.datetime] = None, format_24: bool = True) -> str:
...
def konversi_suhu(suhu: float, dari: str, ke: str) -> float:
    ...
    if dari == "fahrenheit" or dari == "f":
        ...
        raise CodingYokValueError("Unit suhu tidak valid. Gunakan: celsius, fahrenheit, kelvin")
