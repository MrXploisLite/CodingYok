...
class CodingYokIndexError(CodingYokRuntimeError):
    ...
    def __init__(self, message: str = "Indeks di luar jangkauan", line: Optional[int] = None, column: Optional[int] = None):
...
class CodingYokKeyError(CodingYokRuntimeError):
    ...
    def __init__(self, key: Any, line: Optional[int] = None, column: Optional[int] = None):
...
class CodingYokAttributeError(CodingYokRuntimeError):
    ...
    def __init__(self, obj_type: str, attr: str, line: Optional[int] = None, column: Optional[int] = None):
        super().__init__(f"Objek '{obj_type}' tidak memiliki atribut '{attr}'", line, column)
...
class CodingYokImportError(CodingYokRuntimeError):
    ...
    def __init__(self, module_name: str, line: Optional[int] = None, column: Optional[int] = None):
...
class CodingYokIndentationError(CodingYokSyntaxError):
    ...
    def __init__(self, message: str = "Kesalahan indentasi", line: Optional[int] = None, column: Optional[int] = None):
        super().__init__(message, line, column)
